...
Todos levam junto: `page_type` (`saude`), `utm_source`, `utm_medium`,
...
Este projeto tem um irmão: **Regularização Veicular**, com a mesma identidade visual e a mesma estrutura. As duas pastas são independentes: cada uma tem o seu `config.js` e pode ser publicada em um domínio (ou subdomínio) diferente.
